...
export default function LoginFormAdmin() {
    ...
    const handleSignupSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await backendHelper.createAdmin(userData)
    ...
    const handleLoginSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await backendHelper.adminLogin(loginData)
                                            ...
                                            <div className="relative">
                                                ...
                                                >
                                                    <Input
                                                        ...
                                                        className={`pl-10 pr-10 text-sm w-80 h-10 ${errors.password ? 'border-red-500' : ''}`}
                                            ...
                                            <div className="relative">
                                                ...
                                                >
                                                    <Input
                                                        ...
                                                        className={`pl-10 pr-10 text-sm w-80 h-10 ${errors.confirmPassword ? 'border-red-500' : ''}`}
